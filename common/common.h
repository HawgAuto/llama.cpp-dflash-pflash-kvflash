...
struct common_params {
    ...
    // Experimental Lucebox feature ports. These are parsed and reported by this
    // fork first; runtime wiring is added behind these fields.
    int32_t kvflash_tokens = 0;
    int32_t kvflash_tau    = 64;
    std::string kvflash_policy = "lru";
    std::string kvflash_drafter = "";

    std::string pflash_drafter = "";
    std::string pflash_model = "";
    std::string pflash_score = "uniform";
    float       pflash_keep_ratio = 0.75f;
    std::string pflash_mode = "off";
    int32_t     pflash_drafter_gpu = 0;
    int32_t     pflash_chat_min_tokens = 2048;
    int32_t     pflash_min_keep_tokens = 2048;
    int32_t     pflash_protected_prefix = 64;
    int32_t     pflash_protected_suffix = 512;
    std::string pflash_latest_user_mode = "full";
    int32_t     pflash_latest_user_tail_tokens = 2048;
    bool        pflash_preserve_system = true;
    bool        pflash_preserve_latest_user = true;
    bool        pflash_preserve_role_boundaries = true;
    bool        pflash_preserve_control_tokens = true;
    bool        pflash_preserve_tool_json = false;
    bool        pflash_compress_middle_only = true;
